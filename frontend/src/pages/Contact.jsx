...
function Contact() {
  const handleSubmit = (e) => {
    e.preventDefault();
    // You can add message sending logic here
    ...
    <div className="min-h-screen bg-slate-50/30">
      <div className="max-w-6xl mx-auto px-4 py-16 lg:py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
            Do you have a question or need help? Please send us a message, and we will get back to you as soon as possible.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
              <h2 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
                <TbMessage2 className="text-indigo-600" size={24} /> Contact Information
              </h2>
            ...
            {/* Quick Note Card */}
            <div className="bg-indigo-600 p-8 rounded-[2rem] text-white shadow-xl shadow-indigo-100">
              <h3 className="font-bold text-lg mb-2">We are here for you!</h3>
              <p className="text-indigo-100 text-sm leading-relaxed">
                Our team works 24/7 to help you with any technology-related issues.
              </p>
            </div>
          </div>
